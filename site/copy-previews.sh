...
DST="src/images"
CURATED="home_empty.png session_demo.png session_full.png session_settings.png wizard_provider.png wizard_setup_digitalocean.png wizard_region.png wizard_preview.png session_invites.png session_destinations_key.png session_destinations_live_two.png session_destinations_failed.png"
