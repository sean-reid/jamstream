...
3. **Buffer size.** On the Audio tab, under Buffer size, pick the smallest of 120, 240, or 480 frames (2.5, 5, or 10 ms) that plays clean. Crackles, or the "clicking" tag beside the latency number, mean one step up. A choice below the device's own minimum is annotated with the size the device really delivers.
