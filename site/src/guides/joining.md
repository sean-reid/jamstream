...
- **Hear yourself through the server** is off by default; turning it on puts your own sound in your mix too, on the band's timeline. Needs headphones. A session sitting above about 30 ms mouth to ear is offered it once, above the control. See [The band can't keep together](troubleshooting.md#the-band-cant-keep-together) for why you would.
